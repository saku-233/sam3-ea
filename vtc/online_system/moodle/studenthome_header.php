...
$displayUser = $_SESSION['student_user'] ?? '';
?>
<!DOCTYPE html>
<html lang="zh-Hant">
    ...
    <header>
        <div class="header-container">
            <div class="header-left">
                <a href="index.php">
                    <img src="../../image/logo-default.png" alt="VTC logo" class="nav-logo">
                    <ul class="main-nav">
            ...
            <div class="header-right">
                ...
                <div class="user-profile">
                    <strong style="color: #333;"><?php echo htmlspecialchars($displayUser, ENT_QUOTES, 'UTF-8'); ?></strong>
                    <div class="avatar">
